...
func firebaseLogin(vc: UIViewController, email: String, password: String) {
...
func firebaseSignup(vc: UIViewController, username: String, email: String, password: String) {
...
func firebaseLogout(vc: UIViewController) {
