...
class LoginController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, LoginControllerDelegate {
    ...
    let loginPages: [LoginPage] = {
        let firstPage = LoginPage(title: "Share a great listen", message: "It's free to send your books to the people in your life. Every recipient's first book is on us.", imageName: "page1")
        
        let secondPage = LoginPage(title: "Send from your library", message: "Tap the More menu next to any book. Choose \"Send this Book\"", imageName: "page2")
        
        let thirdPage = LoginPage(title: "Send from the player", message: "Tap the More menu in the upper corner. Choose \"Send this Book\"", imageName: "page3")
        
        return [firstPage, secondPage, thirdPage]
    }()
    
    lazy var loginPageControl: UIPageControl = {
        let pc = UIPageControl()
        pc.pageIndicatorTintColor = .lightGray
        pc.currentPageIndicatorTintColor = UIColor(red: 247/255, green: 154/255, blue: 27/255, alpha: 1)
        pc.numberOfPages = self.loginPages.count + 1
        return pc
    }()
    ...
    @objc func skip() {
        ...
        loginPageControl.currentPage = loginPages.count - 1
        nextPage()
    }
    ...
    @objc func nextPage() {
        ...
        if loginPageControl.currentPage == loginPages.count {
            return
        }
        
        //second last page
        if loginPageControl.currentPage == loginPages.count - 1 {
        ...
        let indexPath = IndexPath(item: loginPageControl.currentPage + 1, section: 0)
        collectionView.scrollToItem(at: indexPath, at: .centeredHorizontally, animated: true)
        loginPageControl.currentPage += 1
    }
    ...
    override func viewDidLoad() {
        ...
        pageControlBottomAnchor = loginPageControl.anchor(nil, left: view.leftAnchor, bottom: view.safeAreaLayoutGuide.bottomAnchor, right: view.rightAnchor, topConstant: 0, leftConstant: 0, bottomConstant: 0, rightConstant: 0, widthConstant: 0, heightConstant: 40)[1]
    ...
    func scrollViewWillEndDragging(_ scrollView: UIScrollView, withVelocity velocity: CGPoint, targetContentOffset: UnsafeMutablePointer<CGPoint>) {
        ...
        loginPageControl.currentPage = pageNumber
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let page = loginPages[(indexPath as NSIndexPath).item]
        cell.page = page
    ...
    override func willTransition(to newCollection: UITraitCollection, with coordinator: UIViewControllerTransitionCoordinator) {
        ...
        let indexPath = IndexPath(item: loginPageControl.currentPage, section: 0)
